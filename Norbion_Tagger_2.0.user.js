...
(function() {
    ...
    function extractUnitType(cell) {
        ...
        // Check for FN in quickedit-label span
        const quickEditLabel = cell.querySelector('.quickedit-label');
        if (quickEditLabel && quickEditLabel.textContent.trim().includes('FN')) {
        ...
        for (let img of unitImages) {
            ...
            if (src.includes('sword.webp')) return 'Sword';
            if (src.includes('spear.webp')) return 'Spear';
            if (src.includes('archer.webp')) return 'Archer';
            if (src.includes('heavy.webp')) return 'Heavy';
            if (src.includes('catapult.webp')) return 'Catapult';
        }
    ...
    function getUnitEmoji(unitType) {
        ...
        switch (unitType) {
            ...
            case 'Axe': return '<:unit_axe:1419105294096535583>';
        ...
        discordPanel.innerHTML = `
            ...
            <div style="padding: 15px;">
                <table class="vis" style="width: 100%; margin-bottom: 15px;">
                    ...
                    <tr>
                        <td style="font-weight: bold; width: 30%;">Webhook URL:</td>
                        <td>
                ...
                <div style="display: flex; gap: 8px; margin-bottom: 10px;">
                    ...
                    <input type="button" value="Test Webhook" id="norbion2-test" class="btn" style="flex: 1; padding: 8px;">
                </div>
    ...
    function saveDiscordSettings() {
        ...
        setStorageData(STORAGE_KEYS.DISCORD_SETTINGS, { webhook: webhook });
